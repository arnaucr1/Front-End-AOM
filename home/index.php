...
<html lang="es">
<head>
	<title>Home - AOM Subscription Manager</title>
	<meta charset="UTF-8">
...
<body class="">
	<main class="concord" id="concord-cards">
		<header>
			<time>
			<h5 id="date"> 30 de Enero</h5> <!-- DATA ACTUAL -->
			<h3 id="day">Mis Suscripciones</h3>
		</time>
		...
		<div class="card x" data-color="" style="">
			...
			<section class="wrapper">
				...
				<footer class="card-footer">
					<p>gghjghj.</p> <input type="button" class="concord" value="€ 9.99">
				</footer>
			</section>
			<div class="content">
		...
		<div class="card x" data-color="" style="">
			...
			<section class="wrapper">
				...
				<footer class="card-footer">
					<p>ghghghgg</p> <input type="button" class="concord" value="€ 99.99">
				</footer>
			</section>
			<div class="content">
				<p><b>Lorem ipsum dolor sit amet</b> consectetur adipiscing elit. Quisque lacinia, turpis ac congue vehicula, ipsum enim semper neque, nec ultrices mauris dui non neque. Phasellus libero purus, viverra sit amet consectetur at, sagittis vel turpis. Quisque nec nulla quis neque pharetra
		...
		<div class="card x" data-color="" style="">
			...
			<section class="wrapper">
				...
				<footer class="card-footer">
					<p>Tghghghhg athghg</p> <input type="button" class="concord" value="€ 129.99">
				</footer>
			</section>
			<div class="content">
				<p><b>Lorem ipsum dolor sit amet</b> consectetur adipiscing elit. Quisque lacinia, turpis ac congue vehicula, ipsum enim semper neque, nec ultrices mauris dui non neque. Phasellus libero purus, viverra sit amet consectetur at, sagittis vel turpis. Quisque nec nulla quis neque pharetra
