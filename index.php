...
<html lang="es">
    ...
    <body>
        <div class="limitador">
            <div class="todo">
                <div class="caja">	
                    <form class="formulario" action="" method="post" >
                        ...
                        <span class="sub-titulo">Versión 0.1</span>
            ...
            <?php 
            $nombre = filter_input(INPUT_POST, "email", FILTER_SANITIZE_STRING);
            $mail = filter_input(INPUT_POST, "password", FILTER_VALIDATE_EMAIL);
